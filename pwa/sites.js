...
function initSitesPanel() {
  ...
  form.addEventListener("submit", (e) => {
    ...
    // websites.txt এ "নাম|url" ফরম্যাট ব্যবহার হয় বলে, নাম বা url এ
    // নিজে থেকে "|" চিহ্ন থাকলে ফাইলে লেখার সময় লাইনটা ভুলভাবে ভেঙে
    // যাবে (পরের বার পড়ার সময় নামের একটা অংশ url এর ভেতরে ঢুকে যাবে) -
    // তাই জমা দেওয়ার আগেই এখানে আটকে দেওয়া হচ্ছে
    if (name.includes("|") || url.includes("|")) {
      showToast('⚠️ নাম বা ঠিকানায় "|" চিহ্ন ব্যবহার করা যাবে না');
      return;
    }
    addSite(name, url);
  });
