...
# regex এ সাধারণ \b (word boundary) বাংলা লেখায় ঠিকভাবে কাজ করে না, তাই
# "পদ" শব্দের ঠিক পরে যাতে আরেকটা বাংলা অক্ষর/মাত্রা না থাকে সেটা
# negative lookahead দিয়ে নিশ্চিত করা হচ্ছে - নাহলে "পদোন্নতি" এর মতো
# শব্দেও "পদ" অংশটা ভুলভাবে ম্যাচ করে ফেলে (যেমন কাছাকাছি কোনো সংখ্যা,
# যেমন সাল, থাকলে সেটাকে ভুলভাবে "পদসংখ্যা" ধরে নেয়)
BANGLA_CHAR = r"[\u0980-\u09FF]"
...
def extract_job_details(pdf_text):
    ...
    post_match = re.search(rf"({DIGIT_CLASS}+)\s*(?:টি)?\s*পদ(?!{BANGLA_CHAR})", pdf_text)
    if post_match:
