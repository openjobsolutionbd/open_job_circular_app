# আজকের নতুন চাকরির খবর (29-07-2026)

- **[প্রথম আলো]** [বাংলাদেশ সেনাবাহিনীতে ৪ ক্যাটাগরির পদে চাকরি, পদমর্যাদা অফিসার ক্যাডেট](https://www.prothomalo.com/chakri/employment/ziv2nyehdu)
  - ⚠️ শেষ তারিখ পাওয়া যায়নি

## যে সাইটগুলোতে সমস্যা হয়েছে

- **brdb.gov.bd** — কারণ: HTTPSConnectionPool(host='brdb.gov.bd', port=443): Max retries exceeded with url: /pages/notices (Caused by SSLError(SSLCertVerificationError(1, '[SSL: CERTIFICATE_VERIFY_FAILED] certificate verify failed: unable to get local issuer certificate (_ssl.c:1016)')))
...
- **dcd.gov.bd** — কারণ: HTTPSConnectionPool(host='dcd.gov.bd', port=443): Max retries exceeded with url: /pages/notices (Caused by SSLError(SSLCertVerificationError(1, '[SSL: CERTIFICATE_VERIFY_FAILED] certificate verify failed: unable to get local issuer certificate (_ssl.c:1016)')))
