...
def make_id(site, link):
    ...
    যাতে একই সার্কুলার দ্বিতীয়বার দেখলে চেনা যায়। site আর link এর
    দৈর্ঘ্য আগে থেকে জুড়ে দেওয়া হচ্ছে (length-prefixed) যাতে কাকতালীয়ভাবে
    site/link এর মধ্যে "|" থাকলেও দুটো ভিন্ন (site, link) জোড়া কখনো
    একই raw string / id তৈরি করতে না পারে।"""
    raw = f"{len(site)}:{site}|{len(link)}:{link}"
